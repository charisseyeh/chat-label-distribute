    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-blue-50 rounded-lg p-4 text-center">
          ...
          <div className="text-small text-blue-600">Average Agreement</div>
        </div>

        {/* Total Conversations */}
        <div className="bg-green-50 rounded-lg p-4 text-center">
          <div className="text-large-semibold text-green-600">
            {comparisonData.length}
          </div>
          <div className="text-small text-green-600">Conversations Analyzed</div>
        </div>

        {/* Questions with Most Disagreement */}
        <div className="bg-yellow-50 rounded-lg p-4 text-center">
          <div className="text-large-semibold text-yellow-600">
            {comparisonData[0]?.differences[0]?.questionText?.substring(0, 20)}...
          </div>
          <div className="text-small text-yellow-600">Most Disputed Question</div>
        </div>
      </div>

      {/* Detailed Analysis */}
      <div className="border border-gray-200 rounded-lg p-4">
        <h4 className="text-small-medium text-gray-900 mb-4">Question-by-Question Analysis</h4>
          ...
          return (
            <div key={question.id} className="border-b border-gray-100 py-3 last:border-b-0">
              <div className="flex justify-between items-start mb-2">
                <span className="text-small-medium text-gray-900">{question.text}</span>
